...
import LogoApp from "../../src/components/survey/LogoApp";
import SurveyType from "../../src/components/survey/SurveyType";
import MyContainer from "../../src/components/v4-material/MyContainer";
...
const ChooseExamDate = dynamic(
  () => import("../../src/components/survey/ChooseExamDate"),
  {
    ssr: false,
        ...
        <MyContainer className="date-survey-container">
          ...
          <div className="date-survey-content">
            ...
            {tab === SELECT_EXAM_DATE_TAB ? (
              <>
                <h1>When will you get your result?</h1>
