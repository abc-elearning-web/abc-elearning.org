...
const EasyPrepTermsOfUse = () => {
  return (
    <>
      ...
      <div className="easy-prep-terms-of-use">
        ...
        <p>
          ...
          related to it, still belong to Easy Prep.
        </p>{" "}
        <p>
          Easy Prep is committed to ensuring that the app is as useful and
        ...
        <p>
          The app stores and processes personal data that you have provided to
          us, to provide our Service. It’s your responsibility to keep your
          ...
          security features and it could mean that the app won’t work properly
          or at all.
        </p>{" "}
        <div>
          <p>
        ...
        <p>
          You should be aware that there are certain things that Easy Prep will
          ...
          Wi-Fi or provided by your mobile network provider, but Easy Prep
        ...
        <p>
          Along the same lines, Easy Prep cannot always take responsibility for
          ...
          avail the Service, Easy Prep cannot accept responsibility.
        </p>{" "}
        <p>
          With respect to Easy Prep’s responsibility for your use of the app,
          ...
          that we can make it available to you. Easy Prep accepts no liability
        ...
        <p>
          ...
          keep using the app. Easy Prep does not promise that it will always
        ...
        <p>These terms and conditions are effective as of 2023-07-18</p>{" "}
        <p>
...
export default EasyPrepTermsOfUse;
