      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <section className="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-4 border border-yellow-200 dark:border-yellow-800 mb-8">
            ...
            <p>
              We are <strong>ABC Elearning</strong> ("Company," "we," "us,"
              "our"). We operate the mobile application (the "App"), as well as
            ...
            <p>
              ...
              and ABC Elearning, concerning your access to and use of the
          ...
          <nav aria-label="Table of contents" className="mb-10 xxx">
            ...
            <ol className="list-decimal pl-6 space-y-1">
              ...
              <li>
                <a href="#ipr">2. INTELLECTUAL PROPERTY RIGHTS</a>
              </li>
              <li>
              ...
              <li>
                <a href="#payments">5. PURCHASES AND PAYMENT</a>
              </li>
              <li>
                <a href="#free-trial">6. FREE TRIAL</a>
              </li>
              <li>
                <a href="#cancellation">7. CANCELLATION</a>
              </li>
              <li>
              ...
              <li>
                <a href="#mobile-license">12. MOBILE APPLICATION LICENSE</a>
              </li>
              <li>
                <a href="#third-party">13. THIRD-PARTY WEBSITES AND CONTENT</a>
              </li>
              <li>
                <a href="#advertisers">14. ADVERTISERS</a>
              </li>
              <li>
                <a href="#management">15. SERVICES MANAGEMENT</a>
              </li>
              <li>
                <a href="#privacy">16. PRIVACY POLICY</a>
              </li>
              <li>
                <a href="#term-termination">17. TERM AND TERMINATION</a>
              </li>
              <li>
                <a href="#modifications">18. MODIFICATIONS AND INTERRUPTIONS</a>
              </li>
              <li>
                <a href="#law">19. GOVERNING LAW</a>
              </li>
              <li>
                <a href="#disclaimer">22. DISCLAIMER</a>
              </li>
              <li>
                <a href="#indemnification">24. INDEMNIFICATION</a>
              </li>
              <li>
                <a href="#user-data">25. USER DATA</a>
              </li>
              <li>
                <a href="#electronic">
              ...
              <li>
                <a href="#california">27. CALIFORNIA USERS AND RESIDENTS</a>
              </li>
              <li>
                <a href="#misc">28. MISCELLANEOUS</a>
              </li>
              <li>
                <a href="#contact">29. CONTACT US</a>
              </li>
            </ol>
          </nav>
          ...
          <section id="ipr">
            ...
            <p>
              ...
              non-exclusive, non-transferable, revocable license to: (i) access
              the Services; and (ii) download or print a copy of any portion of
            ...
            <p>
              ...
              (i) confirm that you have read and agree with our "PROHIBITED
              ...
              explicit, false, inaccurate, deceitful, or misleading; (ii) to the
              extent permissible by applicable law, waive any and all moral
              rights to any such Submission; (iii) warrant that any such
              Submissions are original to you or that you have the necessary
              rights and licenses to submit such Submissions and that you have
              full authority to grant us the above-mentioned rights in relation
              to your Submissions; and (iv) warrant and represent that your
              Submissions do not constitute confidential information. You are
              solely responsible for your Submissions and you expressly agree to
              reimburse us for any and all losses that we may suffer because of
              your breach of this subsection, any third party’s intellectual
          ...
          <section id="payments">
            ...
            <p>
              ...
              including limiting or canceling quantities.
            </p>
          </section>
          ...
          <section id="free-trial">
            <h2>6. FREE TRIAL</h2>
            <p>
              We offer a 3-day free trial to new users who register with the
          ...
          <section id="cancellation">
            ...
            <p>
              All purchases are non-refundable. Your subscriptions may be
              managed by the user and auto-renewal may be turned off in the
              user’s iTunes Account Settings or Google Play Settings. However,
              you are not allowed to cancel the current subscription period
              during its active subscription period. Your cancellation will take
          ...
          <section id="prohibited">
            ...
            <ul>
              <li>
                ...
                to create or compile a collection, database, or directory
              ...
              <li>
                Use any information obtained from the Services to harass or
                harm.
              </li>
              ...
              <li>
                Engage in any automated use of the system or use any data
              ...
              <li>
                Upload or transmit any passive or active information collection
                or transmission mechanism, including 1×1 pixels, web bugs,
              ...
              <li>
                Copy or adapt the Services' software or reverse engineer any of
                the software comprising the Services.
              </li>
              <li>
              ...
              <li>
                ...
                usernames and/or email addresses by electronic or other means
          ...
          <section id="ugc">
            ...
            <p>
              ...
              content and materials to us or on the Services. Contributions may
              be viewable by other users and through third-party websites and
              will be treated per the Services' Privacy Policy. When you create
              or make available any Contributions, you represent and warrant
              various conditions including originality, permissions, and
          ...
          <section id="reviews">
            ...
            <p>
              ...
              remove reviews in our sole discretion, and we assume no liability
              for any review.
            </p>
          </section>
          ...
          <section id="mobile-license">
            ...
            <p>
              ...
              install and use the App on devices you own or control, according
              to these Legal Terms.
            </p>
            <h3>Apple and Android Devices</h3>
            <p>
              Additional terms apply when you use the App obtained from either
              the Apple Store or Google Play. These include warranty
              responsibilities, export controls, and third-party beneficiary
              rights of the App distributors.
            </p>
          </section>
          ...
          <section id="third-party">
            ...
            <p>
              ...
              not investigated, monitored, or checked for accuracy, and we are
              not responsible for them. Inclusion or linking does not imply
              approval or endorsement. You should review third-party terms and
              policies before using their websites or applications.
            </p>
          </section>
          ...
          <section id="advertisers">
            ...
            <p>
              We allow advertisers to display advertisements in certain areas.
              We simply provide the space and have no other relationship with
              advertisers.
            </p>
          </section>
          ...
          <section id="management">
            ...
            <p>
              ...
              appropriate legal action, refuse or limit access, remove excessive
              files and content, and otherwise manage the Services to protect
              our rights and facilitate proper functioning.
            </p>
          </section>
          ...
          <section id="privacy">
            ...
            <p>
              ...
              Policy at{" "}
              <a href="https://passemall.com/privacy">
                https://passemall.com/privacy
              </a>
          ...
          <section id="term-termination">
            ...
            <p>
              ...
              reserve the right to deny access, terminate use or participation,
              or delete your account for any reason, including breach of these
          ...
          <section id="modifications">
            ...
            <p>
              We reserve the right to change, modify, or remove contents at any
              time without notice and have no obligation to update information.
              We cannot guarantee availability of the Services at all times and
              will not be liable for any downtime or discontinuance.
            </p>
          </section>
          ...
          <section id="disclaimer">
            ...
            <p>
              ...
              WARRANTIES, EXPRESS OR IMPLIED. WE MAKE NO WARRANTIES ABOUT THE
              ACCURACY OR COMPLETENESS OF THE SERVICES' CONTENT OR ANY LINKED
              CONTENT, AND ASSUME NO LIABILITY FOR VARIOUS TYPES OF DAMAGES OR
              ERRORS.
            </p>
          </section>
          ...
          <section id="indemnification">
            ...
            <p>
              ...
              due to or arising out of your use of the Services, breach of these
              Legal Terms, violation of rights, or harmful acts toward other
              users.
            </p>
          </section>
          ...
          <section id="user-data">
            ...
            <p>
              ...
              for the purpose of managing performance, as well as data relating
              ...
              relates to any activity you have undertaken. We have no liability
          ...
          <section id="electronic">
            ...
            <p>
              ...
              writing. You agree to the use of electronic signatures and records
              and waive any rights requiring non-electronic records.
            </p>
          </section>
          ...
          <section id="misc">
            ...
            <p>
              ...
              on the Services constitute the entire agreement between you and
              us. Our failure to enforce any right or provision shall not
              operate as a waiver. These Legal Terms operate to the fullest
              extent permissible by law. We may assign any or all rights and
              obligations at any time. We are not responsible for delays or
              failures caused by events beyond our control.
            </p>
            <p>
              There is no joint venture, partnership, employment or agency
              relationship created between you and us. These Legal Terms will
              not be construed against us by virtue of having drafted them. You
              waive any defenses based on the electronic form of these Legal
              Terms and the lack of signing by the parties to execute these
              Legal Terms.
            </p>
          </section>
