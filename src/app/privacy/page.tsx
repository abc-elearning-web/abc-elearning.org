  ...
  return (
    <>
      ...
      <div style={{ padding: 20 }}>
        ...
        <p className="p2">
          <span className="s1">
            ABC E-learning built all apps as the Free apps. This SERVICE is
            provided by ABC E-learning at no cost and is intended for use as is.
        ...
        <p className="p2">
          <span className="s1">
            ...
            our Terms and Conditions, which is accessible at our app unless
          ...
          <li className="li4">
            <span className="s2">
              <a href="https://www.google.com/policies/privacy/">
                <span className="s3">Google Play Services</span>
              </a>
            </span>
          </li>
          <li className="li4">
            <span className="s2">
              <a href="https://firebase.google.com/policies/analytics/">
                <span className="s3">Firebase Analytics</span>
              </a>
            </span>
          </li>
          <li className="li4">
            <span className="s2">
              <a href="https://support.google.com/admob/answer/6128543?hl=en">
                <span className="s3">Google Admob</span>
              </a>
            </span>
          </li>
        </ul>
        ...
        <p className="p2">
          <span className="s1">
            ...
            memory.<span className="Apple-converted-space"> </span>
          </span>
        </p>
        <p className="p2">
          <span className="s1">
        ...
        <ul className="ul1">
          <li className="li6">
            ...
            <span className="s1">To facilitate our Service;</span>
          </li>
          <li className="li6">
            <span className="s2"></span>
            <span className="s1">To provide the Service on our behalf;</span>
          </li>
          <li className="li6">
            <span className="s2"></span>
            <span className="s1">To perform Service-related services; or</span>
          </li>
          <li className="li6">
            <span className="s2"></span>
            <span className="s1">
        ...
        <p className="p2">
          <span className="s1">
            Users under the age of 18 (a “Minor”) shall have their legal
            guardian or parent agree to these Terms and our Privacy Policy on
            their behalf, and such legal guardian or parent shall be responsible
            for all actions taken under the account. We do not share any
            personal data or personally identifiable information received or
            collected from the service unless we have your consent, it is
            required by law, or we are required to do so in order to continue
            providing our service. Further, we do not knowingly collect or store
            sensitive data, or personally identifiable information from anyone
            under the age of 13. Pursuant to COPPA, we do not target or market
            our services to children below the age of 13. Persons under the age
            of 13 are not permitted to use the services. When you create an
            account with us, you guarantee that you are above the age of 13, and
            that the information you provide us is accurate, complete, and
        ...
        <p className="p2">
          <span className="s1">
            You can delete all your data from the app by way: go to the menu and
            tap on "Reset Progress" and select "Remove all".
          </span>
        </p>
        ...
        <p className="p2">
          <span className="s1">
            ...
            on this page.<span className="Apple-converted-space"> </span>
          </span>
        </p>
        <p className="p3">
          <span className="s1">
