...
const ChooseExamDate = ({ sx, onDontKnowYet, onSubmit }: { sx?: React.CSSProperties; onSubmit: any; onDontKnowYet: any }) => {
    const [value, setValue] = React.useState<Dayjs | null>(dayjs(new Date()));
    return (
        <div className="choose-exam-date" style={{ background: "#fff", borderRadius: "12px", ...sx, padding: "16px" }}>
