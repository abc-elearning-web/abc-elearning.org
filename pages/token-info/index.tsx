                ...
                <section className="card">
                    ...
                    <div className="table-wrap">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        • Complete the Daily Challenge with all answers correct. Only
                                        rewarded once per day.
                                    </td>
                                    <td>
                                        <div className="tokens">
                                            <span className="token-plain">
                    ...
                    <ul className="list">
                        <li>
                            ...
                            <span>Maximum token storage: <strong>50 tokens</strong>.</span>
                        </li>
                        <li>
                            <span className="dot"></span>
                            <span>
